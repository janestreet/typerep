(* OASIS_START *)
(* DO NOT EDIT (digest: 909774233d80d9907fa03c12765a3dc3) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("typerep_kernel", ["kernel/lib"], []);
          ("typerep_kernel_syntax", ["syntax/with_typerep"], []);
          ("typerep_core", ["core/lib"], []);
          ("typerep_generics_sexprep", ["generics/sexprep/lib"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [("generics/sexprep/lib", ["core/lib"]); ("core/lib", ["kernel/lib"])]
  }
  ;;
