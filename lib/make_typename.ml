...
module Make1 (X : Named_intf.S1) = struct
  ...
  let named (type p1) of_p1 =
    let typename_of_t = Name_of_x.typename_of_t (Typerep.typename_of_t of_p1) in
    Typerep.Named.T1
      (module struct
        type 'a named = 'a X.t
        type a = p1
...
module Make2 (X : Named_intf.S2) = struct
  ...
  let named (type p1 p2) of_p1 of_p2 =
    let typename_of_t =
      Name_of_x.typename_of_t (Typerep.typename_of_t of_p1) (Typerep.typename_of_t of_p2)
    in
    Typerep.Named.T2
      (module struct
        ...
        let typename_of_t = typename_of_t
        let witness = Type_equal.refl
      end : Typerep.Named.T2
        with type t = (p1, p2) X.t)
  ;;
end
...
module Make3 (X : Named_intf.S3) = struct
  ...
  let named (type p1 p2 p3) of_p1 of_p2 of_p3 =
    let typename_of_t =
      Name_of_x.typename_of_t
    ...
    Typerep.Named.T3
      (module struct
        ...
        let typename_of_t = typename_of_t
        let witness = Type_equal.refl
      end : Typerep.Named.T3
        with type t = (p1, p2, p3) X.t)
  ;;
end
...
module Make4 (X : Named_intf.S4) = struct
  ...
  let named (type p1 p2 p3 p4) of_p1 of_p2 of_p3 of_p4 =
    let typename_of_t =
      Name_of_x.typename_of_t
        (Typerep.typename_of_t of_p1)
        (Typerep.typename_of_t of_p2)
    ...
    Typerep.Named.T4
      (module struct
        ...
        let typename_of_t = typename_of_t
        let witness = Type_equal.refl
      end : Typerep.Named.T4
        with type t = (p1, p2, p3, p4) X.t)
  ;;
end
...
module Make5 (X : Named_intf.S5) = struct
  ...
  let named (type p1 p2 p3 p4 p5) of_p1 of_p2 of_p3 of_p4 of_p5 =
    let typename_of_t =
      Name_of_x.typename_of_t
        (Typerep.typename_of_t of_p1)
        (Typerep.typename_of_t of_p2)
    ...
    Typerep.Named.T5
      (module struct
        ...
        let typename_of_t = typename_of_t
        let witness = Type_equal.refl
      end : Typerep.Named.T5
        with type t = (p1, p2, p3, p4, p5) X.t)
  ;;
end
