module Make0 (X : Named_intf.S0) : Typerepable.S0
  with type t := X.t
= struct
  module M = Type_named.Make0(X)
  let typerep_of_t =
    Type.Rep.Named (M.named, None)
...
module Make1 (X : Named_intf.S1) : Typerepable.S1
  with type 'a t := 'a X.t
= struct
  module M = Type_named.Make1(X)
  let typerep_of_t of_p1 =
    Type.Rep.Named (M.named of_p1, None)
  let typename_of_t = M.typename_of_t
end
...
= struct
  module M = Type_named.Make2(X)
  let typerep_of_t of_p1 of_p2 =
    Type.Rep.Named (M.named of_p1 of_p2, None)
  let typename_of_t = M.typename_of_t
end
...
= struct
  module M = Type_named.Make3(X)
  let typerep_of_t of_p1 of_p2 of_p3 =
    Type.Rep.Named (M.named of_p1 of_p2 of_p3, None)
  let typename_of_t = M.typename_of_t
end
...
= struct
  module M = Type_named.Make4(X)
  let typerep_of_t of_p1 of_p2 of_p3 of_p4 =
    Type.Rep.Named (M.named of_p1 of_p2 of_p3 of_p4, None)
  let typename_of_t = M.typename_of_t
end
...
= struct
  module M = Type_named.Make5(X)
  let typerep_of_t of_p1 of_p2 of_p3 of_p4 of_p5 =
    Type.Rep.Named (M.named of_p1 of_p2 of_p3 of_p4 of_p5, None)
  let typename_of_t = M.typename_of_t
end
